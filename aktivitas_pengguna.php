...
// PROSES DELETE (ASPIRASI, KOMENTAR, & PENDAFTARAN)
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($aksi_hapus == 'hapus') {
        ...
        if ($stmt_delete_daftar->execute()) {
            echo "<script>alert('Pendaftaran berhasil dibatalkan/dihapus!'); window.location.href = 'aktivitas_pengguna.php';</script>";
            exit;
        }
...
<head>
    ...
    <style>
        ...
        /* Custom Header Tabel dengan Gradasi Biru */
        .custom-card-header {
...
<body>
    ...
    <div class="container py-5">
                ...
                <div class="col-md-6">
                    <div class="card p-0 overflow-hidden">
                        <div class="custom-card-header">
                            <h5 class="m-0"><i class="bi bi-megaphone-fill text-warning me-2"></i>Sampaikan Aspirasi Baru</h5>
                        </div>
                        <div class="p-4">
        ...
        <?php elseif ($aksi == 'komentar'): ?>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card p-0 overflow-hidden">
                        <div class="custom-card-header">
                            <h5 class="m-0"><i class="bi bi-chat-square-text-fill text-info me-2"></i>Beri Komentar Baru</h5>
                        </div>
                        <div class="p-4">
                            <form action="aktivitas_pengguna.php" method="POST">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold text-secondary">Pilih Aspirasi yang Ingin Dikomentari</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="isi_komentar" class="form-control" rows="4" required placeholder="Tulis tanggapan atau komentar Anda..."></textarea>
                                </div>
                                <div class="d-flex gap-2">
        ...
        <?php elseif ($aksi == 'browse_daftar' || $aksi == 'daftar'): ?>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card p-0 overflow-hidden">
                        <div class="custom-card-header">
                            <h5 class="m-0"><i class="bi bi-person-vcard-fill text-success me-2"></i>Form Pendaftaran</h5>
                        </div>
                        <div class="p-4">
                            <form action="aktivitas_pengguna.php" method="POST">
                                <div class="mb-3">
        ...
        <?php else: ?>
            <div class="d-flex justify-content-between align-items-center mb-4 row g-3">
                ...
                <div class="col-md-6 d-flex gap-2 justify-content-center justify-content-md-end">
                    <a href="aktivitas_pengguna.php?aksi=tambah" class="btn btn-blue fw-semibold shadow-sm btn-sm px-3 py-2"><i class="bi bi-megaphone-fill me-1 text-warning"></i> + Aspirasi</a>
                    <a href="aktivitas_pengguna.php?aksi=komentar" class="btn btn-outline-blue fw-semibold shadow-sm btn-sm px-3 py-2"><i class="bi bi-chat-left-text-fill me-1"></i> + Komentar</a>
                    <a href="aktivitas_pengguna.php?aksi=daftar" class="btn btn-orange fw-semibold shadow-sm btn-sm px-3 py-2"><i class="bi bi-person-plus-fill me-1"></i> + Daftar Kegiatan</a>
                </div>
            </div>
            ...
            <div class="card mb-4 overflow-hidden">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php
                            $stmt1 = $conn->prepare("SELECT id_aspirasi, tanggal, judul, kategori, status FROM aspirasi WHERE id_mahasiswa = ? ORDER BY tanggal DESC");
                                ...
                                while($row = $result1->fetch_assoc()) {
                                    ...
                                    echo "<tr>
                                            ...
                                            <td class='text-center'>
                                                <a href='aktivitas_pengguna.php?aksi=hapus&id={$row['id_aspirasi']}' class='btn btn-sm btn-delete-action border-0 px-2' onclick='return confirm(\"Apakah Anda yakin ingin menghapus aspirasi ini?\")'>
            ...
            <div class="card mb-4 overflow-hidden">
                <div class="custom-card-header d-flex align-items-center">
                    <i class="bi bi-chat-square-text-fill text-warning me-2 fs-5"></i>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php
                            $stmt2 = $conn->prepare("SELECT k.id_komentar, k.tanggal, k.isi_komentar, a.judul 
                                                     FROM komentar k 
                            ...
                            if ($result2->num_rows > 0) {
                                while($row = $result2->fetch_assoc()) {
                                    ...
                                    echo "<tr>
                                            ...
                                            <td class='text-center'>
                                                <a href='aktivitas_pengguna.php?aksi=hapus_komentar&id={$row['id_komentar']}' class='btn btn-sm btn-delete-action border-0 px-2' onclick='return confirm(\"Apakah Anda yakin ingin menghapus komentar ini?\")'>
                                                    <i class='bi bi-trash3-fill'></i>
                                                </a>
                                            </td>
                                          </tr>";
                                ...
                                echo "<tr><td colspan='4' class='text-center py-4 text-muted'>Belum ada data komentar.</td></tr>";
                            }
                            $stmt2->close();
                            ?>
                        </tbody>
            ...
            <div class="card overflow-hidden">
                <div class="custom-card-header d-flex align-items-center">
                    <i class="bi bi-person-vcard-fill text-warning me-2 fs-5"></i>
                            ...
                            if ($result3->num_rows > 0) {
                                while($row = $result3->fetch_assoc()) {
                                    ...
                                    echo "<tr>
                                            ...
                                            <td class='text-center'>
                                                <a href='aktivitas_pengguna.php?aksi=hapus_pendaftaran&id={$row['id_pendaftaran']}' class='btn btn-sm btn-delete-action border-0 px-2' onclick='return confirm(\"Apakah Anda yakin ingin membatalkan/menghapus pendaftaran ini?\")'>
                                                    <i class='bi bi-trash3-fill'></i>
                                                </a>
                                            </td>
                                          </tr>";
