...
if (!$organisasi) {
    die('Query organisasi gagal: ' . mysqli_error($conn));
}
...
<div class="page-light">
    <section class="section-heading-row">
        <div>
            ...
            <p class="lead-text">
                Sampaikan masukan, kritik, keluhan, atau saran kepada organisasi kampus.
            </p>
        </div>
    ...
    <section class="form-shell">
        ...
        <form class="aspirasi-form" action="proses_aspirasi.php" method="POST">
            ...
            <select name="id_organisasi">
                ...
                <?php while ($org = mysqli_fetch_assoc($organisasi)) { ?>
            ...
            <input 
                type="text" 
                name="judul" 
                placeholder="Contoh: Perbaikan informasi kegiatan organisasi" 
                maxlength="255" 
                required
            >
            ...
            <textarea 
                name="isi_aspirasi" 
                rows="8" 
                placeholder="Tulis aspirasi secara jelas dan spesifik..." 
                required
            ></textarea>
            ...
            <button 
                type="submit" 
                class="btn-submit" 
                <?= (!$schemaReady || !$mahasiswa) ? 'disabled' : ''; ?>
            >
                Kirim Aspirasi
            </button>
        </form>
